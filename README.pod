...
=head1 The Mynx module

This is the I<README> for the L<Mynx> Perl module.
...
To read about L<Mynx>, look at the embedded documentation
...
L<MetaCPAN|http://www.metacpan.org/module/Mynx>.
...
=item *	L<https://github.com/briandfoy/mynx>

=back

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/mynx/issues>:

=over 4

=item *	L<https://github.com/briandfoy/mynx/issues>
